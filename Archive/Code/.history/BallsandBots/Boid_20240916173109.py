...
class Boid_BOLT:
    ...
    def get_position(self):
        ...
        velocity = self.calculate_vel(self.toy)
        heading = self.toy.get_heading()
        ...
        with SpheroEduAPI(self.toy) as boid:
            ...
            try:
                for count in range(0, 240):
                    ...
                    if target_x > 150 or target_x < -150:
                        print("out of bounds")
                    ...
                    if target_y > 150 or target_y < -150:
    ...
    def run_boid(self, delay):
        ...
        try:
            for count in range(0, 240):
                ...
                if target_y > 1500 or target_y < -1500:
