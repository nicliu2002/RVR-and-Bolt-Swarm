...
class Boid:
    ...
    def __init__(self, swarm, viconInstance, subject_ind):
        self.swarm = swarm
    ...
    def calculate_heading(self):
        ...
        lastX, lastY = self.Locator.get_position(self.subject_ind)
        time.sleep(0.5)
        nowX, nowY = self.Locator.get_position(self.subject_ind)
        ...
        with SpheroEduAPI(self.toy) as boid:
            ...
            try:
                for count in range(0, 240):
                    ...
                    x, y =  self.Locator.get_position(self.subject_ind)
