...
def update(frame):
    ...
    if frame < len(df_SB5938):
        ...
        # Update quiver
        SB5938_vector = ax.quiver(x_SB5938, y_SB5938, u_SB5938, v_SB5938, color='blue', scale=100)
    else:
        SB5938_point.set_data([], [])
        SB5938_vector = ax.quiver([], [], [], [], color='blue', scale=100)
...
ani = FuncAnimation(fig, update, frames=max_frames, init_func=init, blit=False, repeat=True)
