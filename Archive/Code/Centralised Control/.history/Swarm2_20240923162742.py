...
class Swarm2:
    ...
    def __init__(self, names, viconInstance, log_path = "latest.txt"):
    ...
    def get_neighbourhood_align(self, x, y, radius, vision_theta):
        ...
        for boid in self.boids:
            ...
            if dist < radius and dir < vision_theta/2 and dir > -(vision_theta/2):
                ...
                # attempting to flip vectors...?
                
                vec_x = vec_x + speedb*math.cos(math.radians(thetab))
                vec_y = vec_y + speedb*math.sin(math.radians(thetab))
