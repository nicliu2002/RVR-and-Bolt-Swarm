...
class Location:
    ...
    def getPosition(self):
        ...
        global_position = client.GetSegmentGlobalTranslation(subject_names[subject_ind], subject_names[subject_ind])
        xVicon = global_position[0][0]/10
        yVicon = global_position[0][1]/10
        data = str(segment_names) + " , " + str(xVicon) + ", " + str(yVicon)
...
class Agent:
    ...
    def __init__(self, toy, mas, subject_ind):
        ...
        self.toy = toy 
        self.subject_ind = subject_ind
        self.Locator = Location(self.toy,mas,)
        self.WAYPOINT_RANGE = 50
