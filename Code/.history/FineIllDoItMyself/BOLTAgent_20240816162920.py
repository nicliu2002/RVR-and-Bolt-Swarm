...
class BOLTAgent:
    ...
    def __init__(self, start_position, start_heading_angle, robot_size, robot_id, robot_name):
        ...
        self.command_time_step = 100 # it mean run command each command_time_step ms
    ...
    def start_signal(self):
        self.run_agent()
        print("bolt start signal received")
        
        
    # Handler for locator sensor data - this function finds the location the agent
    ...
    def run_agent(self):
        ...
        while True:
            try:
                ...
                if time_step % self.command_time_step == 0:
    ...
    def programe_termination(self, signum, frame):
        ...
        """
        print(f"BOLT Termination signal received (Signal {signum}). Cleaning up...")
