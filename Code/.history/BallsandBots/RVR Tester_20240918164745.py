...
try:
    ...
    theta = controller.lastHeading # gets robot initial heading

    # print("current location data: X: " + str(x) + "     Y: " + str(y) + "     Theta: " + str(theta))

    target_x = -40 # converts x grid coordinates to local positioning system coordinates
    target_y = 120 # converts y grid coordinates to local positioning system coordinates
    ...
    while dist_error >= 1:
        ...
        controller.set_speed(75) # robot moves at minimal speed to overcome carpet friction to prevent over correction
