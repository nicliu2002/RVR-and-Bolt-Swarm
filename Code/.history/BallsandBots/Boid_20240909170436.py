...
class Boid:
    ...
    def __init__(self, swarm, viconInstance):
        self.swarm = swarm
    ...
    def calculate_heading(self):
        ...
        lastX, lastY = self.Locator.get_position()
        time.sleep(0.5)
        nowX, nowY = self.Locator.get_position()
        ...
        with SpheroEduAPI(self.toy) as boid:
            ...
            try:
                for count in range(0, 240):
                    ...
                    x, y =  self.Locator.get_position()
                    velocity = self.calculate_vel(boid)
                    theta = self.calculate_heading()
                    if theta == 0:
