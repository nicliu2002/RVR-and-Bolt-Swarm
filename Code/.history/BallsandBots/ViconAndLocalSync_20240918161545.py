...
with SpheroEduAPI(toy) as api:
    ...
    target_x = 100 # converts x grid coordinates to local positioning system coordinates
    target_y = 100 # converts y grid coordinates to local positioning system coordinates
    ...
    while dist_error >= 0.5:
        ...
        theta_error = 180*math.atan2(target_y-progressiveY, target_x-progressiveX)/math.pi
